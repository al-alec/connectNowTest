...
const components = {};
function componentsPlugin_fa92d9b8(nuxtApp) {
...
const vueuseHead_32fbfa22 = defineNuxtPlugin((nuxtApp) => {
...
const plugin_7f2178e3 = defineNuxtPlugin((nuxtApp) => {
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<nav${serverRenderer.exports.ssrRenderAttrs(_attrs)}><ul class="flex flex-col lg:flex-row uppercase gap-8 py-16 px-8 text-4xl font-extrabold"><li style="${serverRenderer.exports.ssrRenderStyle(_ctx.$route.path == "/" ? "text-shadow: -16px -17px 1px rgba(206,206,194,0.43)" : "")}">`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_router_link, { to: "/" }, {
  ...
  _push(`</li><li style="${serverRenderer.exports.ssrRenderStyle(_ctx.$route.path == "/contact" ? "text-shadow: -16px -17px 1px rgba(206,206,194,0.43)" : "")}">`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, { to: "/contact" }, {
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`Contact`);
      } else {
...
const Navbar = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$1]]);
const meta$1 = void 0;
async function useGameList() {
  let games;
  const [response] = await Promise.all([
    axios.get("http://public.connectnow.org.uk/applicant-test/", {
      proxy: false
    })
  ]);
...
const _sfc_main$8 = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    const games = vue_cjs_prod.ref(([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useGameList()), __temp = await __temp, __restore(), __temp));
    const gamename = vue_cjs_prod.ref("");
    vue_cjs_prod.ref("name");
    const gamelist = vue_cjs_prod.computed(() => vue_cjs_prod.unref(games).filter((game) => gamename.value.toString().length > 0 ? game.name.toString().toLowerCase().includes(gamename.value.toString().toLowerCase()) : vue_cjs_prod.unref(games)));
    const truncate = (str, n) => {
      return str.length > n ? str.substr(0, n - 1) + "..." : str;
    };
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "body" }, _attrs))}>`);
      _push(serverRenderer.exports.ssrRenderComponent(Navbar, null, null, _parent));
      _push(`<div class="flex flex-col lg:flex-row justify-center gap-4 px-8"><div style="${serverRenderer.exports.ssrRenderStyle({ "height": "fit-content" })}" class="bg-card p-4 flex flex-col gap-4"><h3 class="text-xl">Filter Results</h3><div class="flex flex-col gap-2"><label>Name (contains)</label><input class="bg-[#182c47] text-[#c1d1e8] py-2 px-2"${serverRenderer.exports.ssrRenderAttr("value", gamename.value)}></div><div class="flex flex-col sm:flex-row lg:flex-col gap-6"><div class="flex flex-col gap-2"><label>Miminum Score</label><input class="bg-[#182c47] text-[#c1d1e8] py-2 px-2" value="1 - 10"></div><div class="flex flex-col gap-2 flex-1"><label>Order by</label><div class="flex"><div class="bg-accentblue w-1/5 py-1 px-3 justify-center flex"><svg class="w-7 h-7" enable-background="new 0 0 32 32" viewBox="0 0 32 32" fill="white" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="#fff" stroke-miterlimit="10" stroke-width="2"><path d="m16 6v22"></path><path d="m7.5 14 8.5-8.5 8.5 8.5"></path></g></svg></div><select class="bg-[#182c47] border-transparent text-[#c1d1e8] flex-1 py-2 px-2"><option value="date">Release Date</option><option value="score">Score</option><option value="name">Name</option></select></div></div></div><div class="flex justify-end"><button class="px-4 py-1 bg-accentblue"> Clear </button></div></div><div class="flex flex-col gap-2 w-full lg:w-8/12">`);
      if (vue_cjs_prod.unref(gamelist).length > 0) {
        _push(`<!--[-->`);
        serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(gamelist), (game) => {
          _push(`<div class="flex flex-col sm:flex-row w-full"><div class="sm:w-4/12 lg:w-2/12 bg-[#000000] w-full h-[160px] sm:h-[inherit]"></div><div class="flex flex-col px-4 py-4 gap-2 flex-1 bg-card"><h2 class="text-2xl">${serverRenderer.exports.ssrInterpolate(game.name)}</h2><p class="text-gray-400">Release Date: DD/MM/YYYY</p><p class="text-sm text-gray-400">${serverRenderer.exports.ssrInterpolate(truncate(game.summary, 300))}</p></div></div>`);
        });
        _push(`<!--]-->`);
      } else {
        _push(`<div class="flex flex-row flex-1 justify-center items-center"><p class="text-center">No data</p></div>`);
      }
      _push(`</div></div></div>`);
    };
  }
...
const routes = [
  {
    name: "contact",
    path: "/contact",
    file: "C:/Users/__smartHolder/Desktop/cnow/nuxt3-app/pages/contact.vue",
    children: [],
    meta: meta$1,
    alias: [],
  ...
  },
  {
    name: "index",
    path: "/",
    file: "C:/Users/__smartHolder/Desktop/cnow/nuxt3-app/pages/index.vue",
    children: [],
    meta,
    alias: [],
    component: () => Promise.resolve().then(function() {
...
const router_2b76e4c1 = defineNuxtPlugin((nuxtApp) => {
...
const Error404 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-7371678c"]]);
const _sfc_main$6 = {
  __ssrInlineRender: true,
  props: {
    appName: {
...
const Error500 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-5d1604e8"]]);
const _sfc_main$4 = {
  __ssrInlineRender: true,
  props: {
    error: Object
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div class="flex flex-row justify-center gap-4 px-8"><div class="flex flex-col gap-4 w-2/5"><h1 style="${serverRenderer.exports.ssrRenderStyle({ "font-size": "40px" })}">Get in Touch</h1><p class="text-gray-400"> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&#39;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. </p><div style="${serverRenderer.exports.ssrRenderStyle({ "height": "fit-content" })}" class="bg-card p-4 flex flex-col gap-4"><h1 style="${serverRenderer.exports.ssrRenderStyle({ "font-size": "25px" })}">Contact form</h1><div class="flex flex-row gap-4 w-full"><div class="flex flex-col w-full gap-2"><label>Name *</label><input class="bg-[#182c47] text-[#c1d1e8] py-2 px-2 w-full"></div><div class="flex flex-col w-full gap-2"><label>Email Adress*</label><input class="bg-[#182c47] text-[#c1d1e8] py-2 px-2 w-full" type="email"></div></div><div class="flex flex-row lg:flex-col gap-6"><div class="flex flex-col gap-2"><label>Message</label><textarea class="bg-[#182c47] border-transparent text-[#c1d1e8] flex-1 py-2 px-2"></textarea></div></div><div class="flex justify-end"><button class="px-4 py-1 bg-accentblue"> Send </button></div></div></div></div></div>`);
}
